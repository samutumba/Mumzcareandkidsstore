...
<div className="flex items-center">   
    ...
    <div className="relative w-full">
        ...
        <input type="text" id="voice-search" value={input} className=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-rose focus:border-rose block w-full pl-10 p-2.5 " placeholder="Search Pampers, Dresses, Car Seats..." onChange={(e) => setNewInput(e.target.value)} />
