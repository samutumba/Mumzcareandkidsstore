...
export const WishListPage = () => {
    ...
    return (<Layout>
        <div className="h-full flex flex-col gap-2 justify-center px-2 ">
            ...
            {
                wishListItems?.length && wishListItems?.length > 0 && <ProductCarousel title="RECOMMENDED" filter={{ category: wishListItems?.flatMap((p) => p.product.category), subCategory: wishListItems?.flatMap((p) => p.product.subCategory) }} sort={ISort.featured} />
            }
