      ...
      <div className="flex flex-col lg:flex-row gap-4 justify-evenly">
         <div className="lg:w-1/3 px-6 font-title">
            ...
            <ul className="mt-5">
               ...
               <li>
                  <Link to="/policy/cookie-policy" className="flex text-white bg-rose rounded-lg hover:bg-ocean hover:text-white text-xl items-center  my-2 py-2 px-5 font-semibold flex-row gap-4">
            ...
            <p>We use cookies to help improve your experience of our website at <Link to="https://mumzcareandkidsstore.com/">https://mumzcareandkidsstore.com/</Link>. This cookie policy is part of Mumz Care And Kids Store&#39;s privacy policy. It covers the use of cookies between your device and our site. </p>
            ...
            <p>If you don’t wish to accept cookies from us, you should instruct your browser to refuse cookies from <Link to="https://mumzcareandkidsstore.com/">https://mumzcareandkidsstore.com/</Link>. In such a case, we may be unable to provide you with some of your desired content and services. </p>
