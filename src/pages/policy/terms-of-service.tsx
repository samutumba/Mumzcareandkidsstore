   ...
   Terms Of Service
    ...
    <div className="flex flex-col lg:flex-row gap-4 justify-evenly">
       <div className="lg:w-1/3 px-6 font-title">
          ...
          <ul className="mt-5">
             <li>
                <a href="/policy/terms-of-service" className="hover:bg-ocean hover:text-white text-xl font-semibold text-white bg-rose rounded-lg flex flex-row gap-4 items-center my-2 py-2 px-5">
             ...
             <li>
                <a href="/policy/cookie-policy" className="flex text-xl items-center rounded-lg hover:bg-ocean hover:text-white my-2 py-2 px-5 font-semibold flex-row gap-4">
...
<p>These Terms of Service govern your use of the website located at <a href="https://mumzcareandkidsstore.com/">https://mumzcareandkidsstore.com/</a> and any related services provided by Mumz Care And Kids Store. </p>
<p>By accessing <a href="https://mumzcareandkidsstore.com/">https://mumzcareandkidsstore.com/</a>, you agree to abide by these Terms of Service and to comply with all applicable laws and regulations. If you do not agree with these Terms of Service, you are prohibited from using or accessing this website or using any other services provided by Mumz Care And Kids Store. </p>
