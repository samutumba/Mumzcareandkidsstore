   ...
   <div className="flex flex-col lg:flex-row gap-4 justify-evenly">
       <div className="lg:w-1/3 px-6 font-title">
          ...
          <ul className="mt-5">
             ...
             <li>
                <a href="/policy/privacy-policy" className="hover:bg-ocean hover:text-white flex text-white bg-rose rounded-lg  my-2 py-2 px-5 text-xl font-semibold flex-row gap-4 items-center">
                     <Icon icon="dashicons:privacy" className="inline text-3xl"/> Privacy Policy
               </a>
               
             </li>
             <li>
                <a href="/policy/cookie-policy" className="hover:bg-ocean rounded-lg hover:text-white flex text-xl items-center  my-2 py-2 px-5 font-semibold flex-row gap-4">
