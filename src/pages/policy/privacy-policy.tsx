   ...
   return (<Layout>
      ...
      <div className="flex flex-col lg:flex-row gap-4 justify-evenly">
         <div className="lg:w-1/3 px-6 font-title">
            ...
            <ul className="mt-5">
               <li>
                  <Link to="/policy/terms-of-service" className="hover:bg-ocean rounded-lg hover:text-white text-xl font-semibold flex flex-row gap-4 items-center my-2 py-2 px-5">
                     <Icon icon="ic:round-policy" className="inline text-3xl" /> Terms of Service
                  </Link>

               </li>
               <li>
                  <Link to="/policy/privacy-policy" className="hover:bg-ocean hover:text-white flex text-white bg-rose rounded-lg  my-2 py-2 px-5 text-xl font-semibold flex-row gap-4 items-center">
                     <Icon icon="dashicons:privacy" className="inline text-3xl" /> Privacy Policy
                  </Link>

               </li>
               <li>
                  <Link to="/policy/cookie-policy" className="hover:bg-ocean rounded-lg hover:text-white flex text-xl items-center  my-2 py-2 px-5 font-semibold flex-row gap-4">
                     <Icon icon="carbon:cookie" className="inline text-3xl" /> Cookie Policy
                  </Link>
               </li>
            </ul>

         </div><article className="my-4 px-3 lg:px-5 prose">
            <h2>Privacy Policy</h2>
            <p>Your privacy is important to us. It is Mumz Care And Kids Store&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <Link to="https://mumzcareandkidsstore.com/">https://mumzcareandkidsstore.com/</Link> , and other sites we own and operate. </p>
            ...
            <p>Contact Page<br />
               https://mumzcareandkidsstore.com/help </p>
