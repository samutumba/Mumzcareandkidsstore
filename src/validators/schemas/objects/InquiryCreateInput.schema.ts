...
export const InquiryCreateInputObjectSchema = Yup.object({
    id: Yup.string(),  v: Yup.number(),  category: Yup.string().required(),  contact: Yup.string().required(),  feedback: FeedbackCreateNestedManyWithoutInquiriesInputObjectSchema,  message: Yup.string().required(),  name: Yup.string().required(),  reference: Yup.string().required(),  user: UserCreateNestedOneWithoutInquiriesInputObjectSchema,  responded: Yup.boolean(),  type: Yup.string().required(),  updatedAt: Yup.date(),  createdAt: Yup.date()
});
