...
import { ReviewCreateNestedManyWithoutUserInputObjectSchema } from '../internals';;
import { InquiryCreateNestedManyWithoutUserInputObjectSchema } from '../internals';

export const UserCreateWithoutCartInputObjectSchema = Yup.object({
...
Yup.array().of(Yup.string())]),  points: Yup.number(),  policyAccepted: Yup.boolean(),  preferredCommunicationMethod: Yup.string(),  updatedAt: Yup.date(),  username: Yup.string().required(),  email: Yup.mixed().oneOfSchemas([Yup.string()]),  whatsAppNumber: Yup.mixed().oneOfSchemas([Yup.string()]),  googleId: Yup.mixed().oneOfSchemas([Yup.string()]),  facebookId: Yup.mixed().oneOfSchemas([Yup.string()]),  verified: Yup.boolean(),  pickups: PickupCreateNestedManyWithoutUserInputObjectSchema,  wishlist: WishlistCreateNestedManyWithoutUsersInputObjectSchema,  sales: SaleCreateNestedManyWithoutUserInputObjectSchema,  reviews: ReviewCreateNestedManyWithoutUserInputObjectSchema,  inquiries: InquiryCreateNestedManyWithoutUserInputObjectSchema
});
