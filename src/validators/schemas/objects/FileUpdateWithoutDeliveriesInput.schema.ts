...
export const FileUpdateWithoutDeliveriesInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  updatedAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  createdAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  events: EventUpdateOneWithoutFilesNestedInputObjectSchema,  pickups: PickupUpdateOneWithoutFilesNestedInputObjectSchema,  locations: LocationUpdateOneWithoutImagesNestedInputObjectSchema,  products: ProductUpdateOneWithoutImagesNestedInputObjectSchema,  admins: AdminUpdateManyWithoutProfileNestedInputObjectSchema
});
