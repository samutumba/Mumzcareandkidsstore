...
import { PickupUncheckedCreateNestedManyWithoutUserInputObjectSchema } from '../internals';;
...
export const UserUncheckedCreateWithoutReviewsInputObjectSchema = Yup.object({
...
Yup.array().of(Yup.string())]),  points: Yup.number(),  policyAccepted: Yup.boolean(),  preferredCommunicationMethod: Yup.string(),  updatedAt: Yup.date(),  username: Yup.string().required(),  email: Yup.mixed().oneOfSchemas([Yup.string()]),  whatsAppNumber: Yup.mixed().oneOfSchemas([Yup.string()]),  googleId: Yup.mixed().oneOfSchemas([Yup.string()]),  facebookId: Yup.mixed().oneOfSchemas([Yup.string()]),  verified: Yup.boolean(),  pickups: PickupUncheckedCreateNestedManyWithoutUserInputObjectSchema,  cart: CartUncheckedCreateNestedManyWithoutUsersInputObjectSchema,  wishlist: WishlistUncheckedCreateNestedManyWithoutUsersInputObjectSchema,  sales: SaleUncheckedCreateNestedManyWithoutUserInputObjectSchema,  inquiries: InquiryUncheckedCreateNestedManyWithoutUserInputObjectSchema
});
