...
Yup.lazy(() => NestedFloatNullableWithAggregatesFilterObjectSchema.default(undefined))]),  _count: NestedIntNullableFilterObjectSchema,  _avg: NestedFloatNullableFilterObjectSchema,  _sum: NestedFloatNullableFilterObjectSchema,  _min: NestedFloatNullableFilterObjectSchema,  _max: NestedFloatNullableFilterObjectSchema,  isSet: Yup.boolean()
});
