...
import { SaleUpdateManyWithoutUserNestedInputObjectSchema } from '../internals';;
...
export const UserUpdateWithoutPickupsInputObjectSchema = Yup.object({
...
BoolFieldUpdateOperationsInputObjectSchema]),  cart: CartUpdateManyWithoutUsersNestedInputObjectSchema,  wishlist: WishlistUpdateManyWithoutUsersNestedInputObjectSchema,  sales: SaleUpdateManyWithoutUserNestedInputObjectSchema,  reviews: ReviewUpdateManyWithoutUserNestedInputObjectSchema,  inquiries: InquiryUpdateManyWithoutUserNestedInputObjectSchema
});
