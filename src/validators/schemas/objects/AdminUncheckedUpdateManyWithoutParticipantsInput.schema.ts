...
export const AdminUncheckedUpdateManyWithoutParticipantsInputObjectSchema = Yup.object({
...
NullableStringFieldUpdateOperationsInputObjectSchema]),  eventsId: Yup.mixed().oneOfSchemas([AdminUpdateeventsIdInputObjectSchema,
