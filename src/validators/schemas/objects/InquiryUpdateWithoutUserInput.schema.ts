...
import { FeedbackUpdateManyWithoutInquiriesNestedInputObjectSchema } from '../internals';;
import { BoolFieldUpdateOperationsInputObjectSchema } from '../internals';;
import { DateTimeFieldUpdateOperationsInputObjectSchema } from '../internals';

export const InquiryUpdateWithoutUserInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  feedback: FeedbackUpdateManyWithoutInquiriesNestedInputObjectSchema,  message: Yup.mixed().oneOfSchemas([Yup.string(),
