...
export const ProductUpdateWithoutReviewsInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  updatedAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  cartItem: CartItemUpdateManyWithoutProductNestedInputObjectSchema,  items: ItemUpdateManyWithoutProductNestedInputObjectSchema
});
