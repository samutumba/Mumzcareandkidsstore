...
import { ReviewUncheckedUpdateManyWithoutUserNestedInputObjectSchema } from '../internals';;
import { InquiryUncheckedUpdateManyWithoutUserNestedInputObjectSchema } from '../internals';

export const UserUncheckedUpdateWithoutWishlistInputObjectSchema = Yup.object({
...
BoolFieldUpdateOperationsInputObjectSchema]),  pickups: PickupUncheckedUpdateManyWithoutUserNestedInputObjectSchema,  cart: CartUncheckedUpdateManyWithoutUsersNestedInputObjectSchema,  sales: SaleUncheckedUpdateManyWithoutUserNestedInputObjectSchema,  reviews: ReviewUncheckedUpdateManyWithoutUserNestedInputObjectSchema,  inquiries: InquiryUncheckedUpdateManyWithoutUserNestedInputObjectSchema
});
