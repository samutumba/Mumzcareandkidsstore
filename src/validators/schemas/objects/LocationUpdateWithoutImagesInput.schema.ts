...
import { PickupUpdateManyWithoutLocationNestedInputObjectSchema } from '../internals';

export const LocationUpdateWithoutImagesInputObjectSchema = Yup.object({
...
Yup.array().of(Yup.string())]),  updatedAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  createdAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  pickups: PickupUpdateManyWithoutLocationNestedInputObjectSchema
});
