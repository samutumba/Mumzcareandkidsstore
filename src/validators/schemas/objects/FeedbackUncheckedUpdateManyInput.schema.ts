...
export const FeedbackUncheckedUpdateManyInputObjectSchema = Yup.object({
...
NullableStringFieldUpdateOperationsInputObjectSchema]),  adminsId: Yup.mixed().oneOfSchemas([Yup.string(),
