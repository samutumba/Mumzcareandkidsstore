...
import { ItemUpdateManyWithoutProductNestedInputObjectSchema } from '../internals';

export const ProductUpdateWithoutImagesInputObjectSchema = Yup.object({
...
BoolFieldUpdateOperationsInputObjectSchema]),  keywords: Yup.mixed().oneOfSchemas([ProductUpdatekeywordsInputObjectSchema,
...
StringFieldUpdateOperationsInputObjectSchema]),  updatedAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  cartItem: CartItemUpdateManyWithoutProductNestedInputObjectSchema,  reviews: ReviewUpdateManyWithoutProductsNestedInputObjectSchema,  items: ItemUpdateManyWithoutProductNestedInputObjectSchema
});
