...
export const AdminUncheckedUpdateWithoutFeedbacksInputObjectSchema = Yup.object({
...
NullableStringFieldUpdateOperationsInputObjectSchema]),  events: EventUncheckedUpdateManyWithoutParticipantsNestedInputObjectSchema,  eventsId: Yup.mixed().oneOfSchemas([AdminUpdateeventsIdInputObjectSchema,
