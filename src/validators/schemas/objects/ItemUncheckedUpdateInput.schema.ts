...
import { SaleUncheckedUpdateManyWithoutItemsNestedInputObjectSchema } from '../internals';;
import { ItemUpdatesalesIdInputObjectSchema } from '../internals';

export const ItemUncheckedUpdateInputObjectSchema = Yup.object({
...
BoolFieldUpdateOperationsInputObjectSchema]),  updatedAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  createdAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  sales: SaleUncheckedUpdateManyWithoutItemsNestedInputObjectSchema,  salesId: Yup.mixed().oneOfSchemas([ItemUpdatesalesIdInputObjectSchema,
Yup.array().of(Yup.string())]),  productsId: Yup.mixed().oneOfSchemas([Yup.string(),
