...
import { EventUpdateManyWithoutParticipantsNestedInputObjectSchema } from '../internals';;
import { AdminUpdateeventsIdInputObjectSchema } from '../internals';

export const AdminUpdateWithoutFeedbacksInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  updatedAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  events: EventUpdateManyWithoutParticipantsNestedInputObjectSchema,  eventsId: Yup.mixed().oneOfSchemas([AdminUpdateeventsIdInputObjectSchema,
