...
import { EventUncheckedUpdateManyWithoutParticipantsNestedInputObjectSchema } from '../internals';;
import { AdminUpdateeventsIdInputObjectSchema } from '../internals';

export const AdminUncheckedUpdateInputObjectSchema = Yup.object({
...
NullableStringFieldUpdateOperationsInputObjectSchema]),  feedbacks: FeedbackUncheckedUpdateManyWithoutAdminNestedInputObjectSchema,  events: EventUncheckedUpdateManyWithoutParticipantsNestedInputObjectSchema,  eventsId: Yup.mixed().oneOfSchemas([AdminUpdateeventsIdInputObjectSchema,
