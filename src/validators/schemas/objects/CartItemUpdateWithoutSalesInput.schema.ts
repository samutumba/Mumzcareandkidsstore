...
export const CartItemUpdateWithoutSalesInputObjectSchema = Yup.object({
...
CartDetailCreateInputObjectSchema]),  cart: CartUpdateOneWithoutItemsNestedInputObjectSchema,  wishlist: WishlistUpdateOneWithoutItemsNestedInputObjectSchema
});
