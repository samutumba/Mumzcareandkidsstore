...
export const ProductUncheckedCreateWithoutReviewsInputObjectSchema = Yup.object({
...
Yup.array().of(Yup.string())]),  maxAge: Yup.number().required(),  minAge: Yup.number().required(),  subCategory: Yup.string().required(),  title: Yup.string().required(),  updatedAt: Yup.date(),  cartItem: CartItemUncheckedCreateNestedManyWithoutProductInputObjectSchema,  items: ItemUncheckedCreateNestedManyWithoutProductInputObjectSchema
});
