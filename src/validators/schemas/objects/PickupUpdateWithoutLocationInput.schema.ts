...
export const PickupUpdateWithoutLocationInputObjectSchema = Yup.object({
    v: Yup.mixed().oneOfSchemas([Yup.number(),
IntFieldUpdateOperationsInputObjectSchema]),  files: FileUpdateManyWithoutPickupsNestedInputObjectSchema,  service: Yup.mixed().oneOfSchemas([Yup.string(),
