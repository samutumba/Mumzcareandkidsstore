...
export const PickupUpdateWithoutFilesInputObjectSchema = Yup.object({
    v: Yup.mixed().oneOfSchemas([Yup.number(),
IntFieldUpdateOperationsInputObjectSchema]),  location: LocationUpdateOneRequiredWithoutPickupsNestedInputObjectSchema,  service: Yup.mixed().oneOfSchemas([Yup.string(),
