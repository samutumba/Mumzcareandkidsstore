...
import { FileUncheckedUpdateManyWithoutDeliveriesNestedInputObjectSchema } from '../internals';;
...
export const DeliveryUncheckedUpdateInputObjectSchema = Yup.object({
    v: Yup.mixed().oneOfSchemas([Yup.number(),
IntFieldUpdateOperationsInputObjectSchema]),  documents: FileUncheckedUpdateManyWithoutDeliveriesNestedInputObjectSchema,  service: Yup.mixed().oneOfSchemas([Yup.string(),
