...
export const CartItemUncheckedUpdateManyWithoutProductsInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  wishlistId: Yup.mixed().oneOfSchemas([Yup.string(),
