...
import { FileUncheckedUpdateManyWithoutEventsNestedInputObjectSchema } from '../internals';;
...
export const EventUncheckedUpdateInputObjectSchema = Yup.object({
    v: Yup.mixed().oneOfSchemas([Yup.number(),
IntFieldUpdateOperationsInputObjectSchema]),  files: FileUncheckedUpdateManyWithoutEventsNestedInputObjectSchema,  completed: Yup.mixed().oneOfSchemas([Yup.boolean(),
