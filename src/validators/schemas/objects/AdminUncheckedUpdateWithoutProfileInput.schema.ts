...
export const AdminUncheckedUpdateWithoutProfileInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  updatedAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  feedbacks: FeedbackUncheckedUpdateManyWithoutAdminNestedInputObjectSchema,  events: EventUncheckedUpdateManyWithoutParticipantsNestedInputObjectSchema,  eventsId: Yup.mixed().oneOfSchemas([AdminUpdateeventsIdInputObjectSchema,
